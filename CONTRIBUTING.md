...
issue](https://github.com/cisagov/ansible-role-samba/issues) in
...
request](https://github.com/cisagov/ansible-role-samba/pulls), you
...
```console
cd ansible-role-samba
pyenv virtualenv <python_version_to_use> ansible-role-samba
pyenv local ansible-role-samba
